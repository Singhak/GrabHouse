package com.grabhouse.grabhouse.receiver;
...
import com.grabhouse.grabhouse.service.HttpService;
...
public class SmsReceiver extends BroadcastReceiver {
        ...
        try {
            if (bundle != null) {
                ...
                for (Object aPdusObj : pdusObj) {
                    ...
                    if (!senderAddress.toLowerCase().contains(Data.SMS_ORIGIN.toLowerCase())) {
                        return;
                    }
    ...
    private String getVerificationCode(String message) {
        String code = null;
        int index = message.indexOf(Data.OTP_DELIMITER);
